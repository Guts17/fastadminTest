<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\wamp64\fastadmin\public/../application/admin\view\video\add.html";i:1565660397;s:62:"D:\wamp64\fastadmin\application\admin\view\layout\default.html";i:1562338655;s:59:"D:\wamp64\fastadmin\application\admin\view\common\meta.html";i:1562338655;s:61:"D:\wamp64\fastadmin\application\admin\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_name" class="form-control" name="row[video_name]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video_aliasname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_aliasname" class="form-control" name="row[video_aliasname]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video_updateinfo'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_updateinfo" class="form-control" name="row[video_updateinfo]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_years" class="form-control datetimepicker" data-date-format="YYYY" data-use-current="true" name="row[video_years]" type="text" value="<?php echo date('Y'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video_tag'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_tag" class="form-control" name="row[video_tag]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-video_desc" class="form-control " rows="5" name="row[video_desc]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video_detailurl'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_detailurl" class="form-control" name="row[video_detailurl]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video_episodeurl'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_episodeurl" class="form-control" name="row[video_episodeurl]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-video_switch" class="form-control" name="row[video_switch]" type="number">
        </div>
    </div>
    <div class="form-group">
